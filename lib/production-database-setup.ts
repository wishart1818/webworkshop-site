...
import {
  ...
  CONTACT_DISCOVERY_MIGRATION_CHECKSUM,
  CONTACT_DISCOVERY_MIGRATION_ID,
  CONTACT_DISCOVERY_MIGRATION_STATEMENTS,
  ...
  OUTREACH_COPY_VERSIONING_MIGRATION_CHECKSUM,
  OUTREACH_COPY_VERSIONING_MIGRATION_ID,
  OUTREACH_COPY_VERSIONING_MIGRATION_STATEMENTS,
  OUTREACH_PREFERENCE_MIGRATION_CHECKSUM,
  ...
  WEBSITE_AVAILABILITY_MIGRATION_CHECKSUM,
  WEBSITE_AVAILABILITY_MIGRATION_ID,
  WEBSITE_AVAILABILITY_MIGRATION_STATEMENTS,
  WEBSITE_VERIFICATION_EVIDENCE_MIGRATION_CHECKSUM,
  WEBSITE_VERIFICATION_EVIDENCE_MIGRATION_ID,
  WEBSITE_VERIFICATION_EVIDENCE_MIGRATION_STATEMENTS,
  WEBSITE_REPAIR_AUDIT_RUN_MIGRATION_CHECKSUM,
  WEBSITE_REPAIR_AUDIT_RUN_MIGRATION_ID,
  WEBSITE_REPAIR_AUDIT_RUN_MIGRATION_STATEMENTS,
...
const ADDITIVE_ENGINE_TABLES = new Set([...ADDITIVE_TOP_PROSPECT_TABLES, ...ADDITIVE_AUTONOMOUS_GROWTH_TABLES, ...ADDITIVE_AUTONOMOUS_LEARNING_TABLES, "WebsiteRepairAuditRun"]);
...
const MIGRATIONS = [
  ...
  {
    id: WEBSITE_AVAILABILITY_MIGRATION_ID,
    checksum: WEBSITE_AVAILABILITY_MIGRATION_CHECKSUM,
    statements: WEBSITE_AVAILABILITY_MIGRATION_STATEMENTS,
  },
  {
  ...
  {
    id: CONTACT_DISCOVERY_MIGRATION_ID,
    checksum: CONTACT_DISCOVERY_MIGRATION_CHECKSUM,
    statements: CONTACT_DISCOVERY_MIGRATION_STATEMENTS,
  },
  {
    id: OUTREACH_COPY_VERSIONING_MIGRATION_ID,
    checksum: OUTREACH_COPY_VERSIONING_MIGRATION_CHECKSUM,
    statements: OUTREACH_COPY_VERSIONING_MIGRATION_STATEMENTS,
  },
  {
    id: WEBSITE_VERIFICATION_EVIDENCE_MIGRATION_ID,
    checksum: WEBSITE_VERIFICATION_EVIDENCE_MIGRATION_CHECKSUM,
    statements: WEBSITE_VERIFICATION_EVIDENCE_MIGRATION_STATEMENTS,
  },
  {
    id: WEBSITE_REPAIR_AUDIT_RUN_MIGRATION_ID,
    checksum: WEBSITE_REPAIR_AUDIT_RUN_MIGRATION_CHECKSUM,
    statements: WEBSITE_REPAIR_AUDIT_RUN_MIGRATION_STATEMENTS,
  },
] as const;
