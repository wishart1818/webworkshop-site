...
| `OUTREACH_FULL_AUTO_SEND_ENABLED` | Auto Email Pilot only | Optional second switch for fully automatic queued-email batches; keep `false` unless intentionally scaling |
